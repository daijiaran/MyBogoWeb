...
:root {
  ...
  --el-border-color-lighter: #333 !important;
  --el-card-border-color: #333 !important;

  /* 卡片背景 */
  --el-fill-color-blank: #1e1e1e !important;
  --el-card-bg-color: #1e1e1e !important;
...
.profile-edit-container {
  ...
  padding: 20px;
  color: var(--text-light);
  background-color: var(--bg-dark); /* 继承根背景 */
...
::v-deep .el-alert--info {
  background-color: #2c3e50; /* 深色提示框背景 */
  border-color: #34495e;
}
::v-deep .el-alert__title,
::v-deep .el-alert__description {
  color: var(--text-light); /* 提示文字颜色 */
}
